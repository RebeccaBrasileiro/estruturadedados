# minimoExe.py
# Ajuste os métodos abaixo psuh_aux, pop_aux e get_min para que
# seja possível encontrar o elemento mínimo de uma pilha simplesmente buscando no topo (peek) da pilha min_stack.
